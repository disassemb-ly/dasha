...
fn test_indirect_base_long_addressing() {
    ...
    assert_eq!(Dasha::disasm(&[0x01, 0x05]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
    ...
    assert_eq!(Dasha::disasm(&[0x01, 0x0d]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
    ...
    assert_eq!(Dasha::disasm(&[0x01, 0x15]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
    ...
    assert_eq!(Dasha::disasm(&[0x01, 0x1d]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
    ...
    assert_eq!(Dasha::disasm(&[0x01, 0x25]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
    ...
    assert_eq!(Dasha::disasm(&[0x01, 0x2d]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
    ...
    assert_eq!(Dasha::disasm(&[0x01, 0x35]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
    ...
    assert_eq!(Dasha::disasm(&[0x01, 0x3d]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
...
fn test_indirect_byte_offset_long_addressing() {
    assert_eq!(Dasha::disasm(&[0x01, 0x40]), Err(Error::ExpectedOffsetByte));
    assert_eq!(
    ...
    assert_eq!(
        Dasha::disasm(&[0x01, 0x44, 0x00]),
        Err(Error::ExpectedOffsetByte)
    );
    assert_eq!(Dasha::disasm(&[0x01, 0x45]), Err(Error::ExpectedOffsetByte));
    assert_eq!(
...
fn test_indirect_long_offset_long_addressing() {
    assert_eq!(
        Dasha::disasm(&[0x01, 0x80, 0x00, 0x00, 0x80]),
        Err(Error::ExpectedOffsetLong)
    );
    assert_eq!(
    ...
    assert_eq!(
        Dasha::disasm(&[0x01, 0x84, 0x00, 0x00, 0x00, 0x00]),
        Err(Error::ExpectedOffsetLong)
    );
    assert_eq!(Dasha::disasm(&[0x01, 0x85]), Err(Error::ExpectedOffsetLong));
    assert_eq!(
